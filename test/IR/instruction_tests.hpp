...
BOOST_AUTO_TEST_CASE(instruction_call) {
    fun::IR::Instruction I{fun::IR::Instruction::Opcode::Call,
                           fun::IR::LocalHandle{0},
                           fun::IR::LocalHandle{1},
                           fun::IR::LocalHandle{2}};
    BOOST_TEST(I.opcode() == fun::IR::Instruction::Opcode::Call);
    BOOST_TEST(I.format() == fun::IR::Instruction::Format::Ternary);
    BOOST_TEST(I.A().is<fun::IR::LocalHandle>());
    BOOST_TEST(I.A().as<fun::IR::LocalHandle>().index == 0);
    BOOST_TEST(I.B().is<fun::IR::LocalHandle>());
    BOOST_TEST(I.B().as<fun::IR::LocalHandle>().index == 1);
    BOOST_TEST(I.C().is<fun::IR::LocalHandle>());
    BOOST_TEST(I.C().as<fun::IR::LocalHandle>().index == 2);
}
